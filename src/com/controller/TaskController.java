...
public class TaskController extends HttpServlet{
	...
	//                        recordsPerPage));    
	            ...
	            request.setAttribute("tasks", dao.getAllTasks((page-1)*recordsPerPage,
                        recordsPerPage));
	            ///////////test code///////////////
	            System.out.println("tasks size Ctrl"+dao.getAllTasks((page-1)*recordsPerPage,
                        recordsPerPage).size());
//	           
	            ...
	            for(TaskBean task:dao.getAllTasks((page-1)*recordsPerPage,
                        recordsPerPage)){
...
//	            }
	        	...
	        	forward = LIST_TASK;
	        	request.setAttribute("tasks", dao.getTasksByProjectName(searchKey,(page-1)*recordsPerPage,
                        recordsPerPage));
	        	System.out.println("tasks size Ctrl"+dao.getAllTasks((page-1)*recordsPerPage,
                        recordsPerPage).size());
//	           
	        	for(TaskBean task:dao.getTasksByProjectName(searchKey,(page-1)*recordsPerPage,
                        recordsPerPage)){
	            	System.out.print("**Ctrl proj name>>"+task.getProjectName());
	            }
	            int noOfRecords = dao.getNoOfRecords();
...
//	        	request.setAttribute("tasks", dao.getTasksByProjectName(searchKey));
