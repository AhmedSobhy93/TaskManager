...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="com.beans.TaskBean" import="java.util.*"%>
	...
	<div class="container-fluid">
		<div class="panel panel-success">
			...
			<div class="panel-heading" align="center">
				<h4>
					<b><font color="black" style=""> 
								<a href="TaskController?action='add'" style="float: left"
						class="btn btn-primary a-btn-slide-text"> <span
							class="glyphicon glyphicon-plus" aria-hidden="true"></span> <span><strong>Add Task</strong></span>
								...
								Welcome <font color="Blue" style=""><%=currentUser.getFirstName() + " " + currentUser.getLastName()%>
						</font> To Task Manager
			...
			<div class="panel-body" align="center">
				...
				<div class="container " style="margin-top: 2%; margin-bottom: 3%;">
					...
					<div class="panel panel-success" style="max-width: 100%;"
						...
						<div class="panel-heading form-group">
							<h2>
								<b><font color="white"> All Available Tasks</font> </b>
							</h2>
							<br>
						...
						<div class="panel-body">
									...
									<tr>
										...
										<c:choose>
											<c:when
												...
												<td><a
													href="TaskController?action=edit&taskID=${task.taskID}"
													class="btn btn-warning a-btn-slide-text"> <span
														class="glyphicon glyphicon-edit" aria-hidden="true"></span>
														<span><strong>Edit</strong></span>
												</a></td>
												<td><a
													href="TaskController?action=delete&taskID=${task.taskID}"
													class="btn btn-danger a-btn-slide-text"> <span
							...
							<ul class="pagination">
								...
								<c:if test="${currentPage != 1}">
									<li><a
										href="TaskController?action=listTask&page=${currentPage - 1}">Previous</a></li>
								</c:if>
			    ...
			    The when condition does not display a link for the current page--%>
								...
								<c:if test="${currentPage lt noOfPages}">
									<li><a
										href="TaskController?action=listTask&page=${currentPage + 1}">Next</a></li>
								</c:if>
							</ul>
							<%
								} else {
							...
							<ul class="pagination">
								...
								<c:if test="${currentPage != 1}">
									<li><a
										href="TaskController?searchKey=<%=request.getParameter("searchKey") %>&action=search&page=${currentPage - 1}">Previous</a></li>
								</c:if>
			    ...
			    The when condition does not display a link for the current page--%>
								...
								<c:forEach begin="1" end="${noOfPages}" var="i">
									<c:choose>
										...
										<c:otherwise>
											<li><a
												href="TaskController?searchKey=<%=request.getParameter("searchKey") %>&action=search&page=${i}">${i}</a></li>
										</c:otherwise>
									</c:choose>
								</c:forEach>
								...
								<c:if test="${currentPage lt noOfPages}">
									<li><a
										href="TaskController?searchKey=<%=request.getParameter("searchKey") %>&action=search&page=${currentPage + 1}">Next</a></li>
								</c:if>
							</ul>
							<%
								}
			...
			<div class="panel-body" align="center">
				...
				<div class="container " style="margin-top: 10%; margin-bottom: 10%;">
					...
					<div class="panel panel-success" style="max-width: 100%;"
						...
						<div class="panel-heading form-group">
							<h2>
								<b><font color="white"> Pleace contact with
